  ...
  const fetchCompletedJobs = async () => {
    try {
      ...
      const transformedJobs = data.map((job: any) => ({
        ...
        student: {
          id: job.student[0].student_id,
          name: job.student[0].student.name || "Unknown",
          email: job.student[0].student.email
        },
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {job.student.name} ({job.student.email})
                        </p>
                      </div>
                      {job.rating && (
                        <div>
